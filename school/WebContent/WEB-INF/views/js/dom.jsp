...
<div class="container" style="width: 1000px; margin: 0 auto;">
	<div class="container" style="width: 1000px; margin: 0 auto;">
		<h3>문서 객체 모델 (DOM)</h3>
		HTML과 XML문서에 대한 프로그래밍 인터페이스<br/>
	...
	<div class="container" style="width: 1000px; margin: 0 auto;">
		<h3>document 객체</h3>
		DOM객체와 최고 상위 객체<br/>
		window안에 있는 HTML문서 자체를<br/>
		document라고 칭함.
		
		<h3>element 객체</h3>
		문서에 삽입되어 태그로 만들어지는 모든 요소
		...
		엘리먼트를 요소 노드라고 칭하며, 어트리뷰트는 속성 노드<br/>
		내부의 글은 텍스트 노드라고 칭함.
	</div>
	...
	<div>
		<div>
			<h3>document.getElementById()의 예제2</h3>
	...
	<div>
		<div>
			<h3>document.getElementById()의 예제3</h3>
...
<script type="text/javascript">
	var dom = {
		...
		selectElementsByTagName : function() {
			...
			for (var i = 6, elem; elem = elems[i]; i--) {
		...
		selectElementsByName : function() {
			...
			for (var i = 2, element; element = elems[i]; i++) {
